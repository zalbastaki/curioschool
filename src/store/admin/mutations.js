const mutations = {
    ...
    setCurrentAdminClasses: (state, currentAdminClasses) => {
        state.currentAdminClasses = [...currentAdminClasses];
    },

    setCurrentAdminClass: (state, currentAdminClass) => {
        state.currentAdminClass = currentAdminClass;
    },
};
